...
rootdir = os.path.dirname(sys.argv[1] + '/Partitions/') #os.path.dirname('/Users/bound_to_love/Downloads/Test02142018/Partitions/')
...
saver = tf.train.import_meta_graph(sys.argv[0].replace('predictions.py','miconia-model.meta'))
print("Print model location: ", sys.argv[0].replace('predictions.py','miconia-model.meta'))
